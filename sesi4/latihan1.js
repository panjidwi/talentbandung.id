...
var webBasic = ["Apel", "Ceri", "Durian", "Anggur", "Sirsak", "Rambutan", "Nangka"];

console.log(webBasic[0]);
console.log(webBasic[4]);
webBasic[4] = "Anggur Merah";
console.log(webBasic[4]);
...
if(nilai >= 6) {
    alert("Selamat anda lulus memuaskan")
} else if (nilai >= 6)  {
    alert ("Selamat, Anda lulus dengan niai pas-pasan")
} else {
    alert ("Coba lagi")
} */
...
function sayHello ( nama ){
    return alert( "Selamat Datang "+nama );
} */
...
function greet() {
    ...
    var inputEmail = document.getElementById('alamatEmail');
    var alamatEmail = inputEmail.value;
    
    alert(name + " " + alamatEmail);
}
