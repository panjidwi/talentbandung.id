$(document).ready(function() {
    ...
    sr.reveal('.menu', {duration: 800, delay: 100, origin: 'left', distance: '100px', reset: false});
    sr.reveal('.nav-search', {duration: 800, delay: 100, origin: 'right', distance: '100px', reset: false});
